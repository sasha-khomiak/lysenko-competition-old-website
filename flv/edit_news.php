...
//---------------	END	READ	VARIABLES
	...
	$end_date=explode('-',stripslashes($row["date"]));
	$year=$end_date[0];	//	THIS LINE	ONLY	FOR	edit_news.php
	...
	// SELECT		FOTO		FROM		news_foto
		for ($i=0; $i<$num_row; $i++)							
		{																							
		$query_foto="SELECT * FROM ".$table1." WHERE date='".$news[$i][0]."' AND n=".$news[$i][4]."	ORDER by date ASC";	
    ...
    <td width="21%" valign="middle" class="text-12-black"><br>
      <form name="form_year" action="edit_news_year.php">
        ...
        <select name="year" onChange="javascript: 
				...
				{
				if (this.value=='del_year')
				{	var year=window.prompt('Внимание все новости за выбранный год будут удалены. Удалить год?','');
					if (year)	location.replace('delete_news.php?year_del='+year);
            ...
            <?php 
				...
				?>
			<option  value="">........................</option>
			<option  value="del_year">Удалить год</option>			
        </select>
      </form></td>
  ...
  <tr>
	...
	<table width="90%" height="30" border="0" cellpadding="0" cellspacing="0">
      <tr bgcolor="#<?php echo  $tbl_bkgr_zagl1; ?>">
        ...
        <td width="12%" align="center" class="text-12-black-bold"><?php  if($view_foto) echo 'Фото';  ?> </td>
	...
	<tr bgcolor="#<?php echo  $tbl_bkgr_zagl2; ?>">
	<td colspan="6">
      <div  class="galery_menu"  id="x"  style="display: none">
        <!--	INSERT	FORM-->
            ...
            <tr>
			  ...
			  <table border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td class="text" height="50" valign="middle" nowrap>
					<input type="text" id="data" name="data" value="дд-мм-гггг" onFocus="this.select(); lcs(this)"
							...
							echo'
							 <tr>
							  ...
							  <td width="200" valign="top">
								<textarea name="headline[]" cols="60" rows="2"  class="text-12-black-bold" id="headline[]" > </textarea>
								</td>
							  <td valign="top">

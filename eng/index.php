    ...
    <div id="container_menu">
		...
		<div id="submenu" 	 > <!--  onmouseout="hide_menu(4);" -->
				...
				<div id="smenu2" class="ramka_menu"> 
					...
					<a href="winners_violin.php">winners </a>					
...
<div align="center">
      ...
      <p class="txt_14_news">
      	  <?php
	  echo '<strong>NEWS:</strong> <a  href="news_2.php?data='.$arr_news[0][0].'&n='.$arr_news[0][2].' ">'.$arr_news[0][1].'...</a>';
	   ?>
  </p>
</div>
  ...
  <tr>
    <td><div id="box1">
       	    ...
       	    <br />
            	<div class="txt_12"><a href="winners_violin.php" target="_self">winners</a></div>
       	</div>
    	</div>
    ...
    <td><div id="box2">
		<div id="comp_section"> 
   	  		<div class="txt_title_24">Piano</div>
                	<br />
            	<div class="txt_12"><a href="winners_piano.php" target="_self">winners</a></div>
       	</div>
    	</div>
    ...
    <br />
            	<div class="txt_12"><a href="winners_vocal.php" target="_self">winners</a></div>
       	</div>
    </div></td>
...
<br />
            	<div class="txt_12"><a href="winners_cello.php" target="_self">winners</a></div>
       	</div>
    </div></td>
  </tr>
</table>

<?php
// INPUT select_year
$select_year=trim($_GET['select_year']);
//---------------	READ	VARIABLES
...
//	VARIABLES
	...
	$data1=$select_year.'-01-01';		$data2=$select_year.'-12-31';
	$account_news=0;
		...
		{	if ($arr_type[$i]!=$arr_type[$i+1]) 
			{
				...
				//echo	$num_year.' ---  num_year  --- '.$arr_year[$num_year].' ---  arr_year[num_year]<br>';
				$num_year++; 
			}
		}
			$arr_year[$num_year]=$arr_type[$i];
...
//---------------------------- SELECT  NEWS
		...
		// if (!$result) {	echo "Нет информации";	exit;	}
        ...
        <tr>
		  ...
		  {		$s='';
				...
				'<table width="90%" border="0" cellspacing="0" cellpadding="0">
              	<tr>
                	<td width="100">
					<a class="txt_12" valign="top" href="news_2.php?data='.$arr_all_news[0][$i].'&n='.$arr_all_news[3][$i].' ">'.$arr_all_news[0][$i].'</a></td>
                	<td >
					<a class="news_title" valign="top" href="news_2.php?data='.$arr_all_news[0][$i].'&n='.$arr_all_news[3][$i].' ">'.$arr_all_news[1][$i].'</a></td>
              	</tr>
              	<tr>
                	<td>&nbsp;</td>
